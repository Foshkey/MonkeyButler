        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FreeCompany_Id = table.Column<string>(nullable: true),
                    FreeCompany_Name = table.Column<string>(nullable: true),
                    FreeCompany_Server = table.Column<string>(nullable: true),
